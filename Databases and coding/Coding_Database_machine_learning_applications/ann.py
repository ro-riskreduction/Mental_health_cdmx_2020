...
#anx_1_str_3_avo_1 = np.vstack ( ( anx_1, str_3 , avo_1 ) ).T

#print(anx_1_str_3)
#print()
#print(anx_1_str_3_avo_1)
...
#ax     = plt.axes()
#colors = ['b','r']
#ax.scatter( x0[:,0], x0[:,1], color=colors[0], s=200, label='Label = No PTSD' )
#ax.scatter( x1[:,0], x1[:,1], color=colors[1], s=200, label='Label = PTSD' )
#ax.set_xlabel('Anxiety question 54', size=14)
#ax.set_ylabel('Acute stress question 39', size=14)
#ax.axis('equal')
#ax.legend()
#plt.show()
